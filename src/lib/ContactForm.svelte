...
<form>
    ...
    <div class="mb-6">
      <label for="message-body" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Message body</label>
